...
class ShapeTrainer(train_utils.Trainer):
    ...
    def set_input(self, batch):
        ...
        if 'camera_params' in list(batch.keys()):
        ...
        if 'model_trans' in list(batch.keys()):
        ...
        if 'model_pose' in list(batch.keys()):
        ...
        if 'model_betas' in list(batch.keys()):
        ...
        if 'model_delta_v' in list(batch.keys()):
        ...
        if opts.texture_map:
            assert('texture_map' in list(batch.keys()))
